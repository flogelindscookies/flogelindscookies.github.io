...
<body>
    ...
    <?php include('errors.php');?>
      ...
      <p>Already a registered? <a href="login_here.php">Sign in</a></p>
    </form>
    ...
    <br /><br />
    	...
    	<div class="row">
            ...
            <div class="col-sm-4">
                ...
                <a href="" class="btnconnect"><img src="../buttons/btn_ig.png"></a>
                <a href="" class="btnconnect"><img src="../buttons/btn_gm.png"></a>
            </div>
            <div class="col-sm-4">
